...
|------|-------|-------|---------|------|
| 2026 | 3 | Standardizing Access to Heterogeneous Quantum Backends: A Case Study on Cloud Service Integration with QDMI | Patrick Hopf, Sebastian Stern, Robert Wille, et al. | [arXiv:2603.05138](https://arxiv.org/abs/2603.05138) |
...
*This table is updated automatically. Run `python bin/update_braket_publications.py` to refresh manually.*
