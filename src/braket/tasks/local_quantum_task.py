...
class LocalQuantumTask(QuantumTask):
    ...
    def create(
        ...
        **kwargs,
        ...
        task._args = args
        task._kwargs = kwargs
        task._convert_to_sim_format(task_specification, shots, inputs=inputs, *args, **kwargs)
        task.async_result()
        return task
    ...
    def _(
        ...
        ir = problem.to_ir()
        self._args = [ir, shots] + list(self._args)
    ...
    def _(
        ...
        self._args = [program.to_ir(), shots] + list(self._args)
