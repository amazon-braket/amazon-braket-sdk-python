...
class NoiseModel:
    ...
    def _apply_readout_noise(
        ...
        new_circuit = cls._apply_measurement_noise(circuit, readout_noise_instructions)
        return cls._apply_noise_on_observable_result_types(new_circuit, readout_noise_instructions)
