...
class AwsSession(object):
    ...
    Args:
        ...
        aqx_client: boto3 aqx client
    """

    # similar to sagemaker sdk:
    # https://github.com/aws/sagemaker-python-sdk/blob/master/src/sagemaker/session.py
    def __init__(self, boto_session=None, aqx_client=None):
        self.boto_session = boto_session or boto3.Session()
        self.aqx_client = aqx_client or self.boto_session.client("aqx", endpoint_url=PDX_BETA_URL)
    ...
    def cancel_quantum_task(self, arn: str) -> None:
        ...
        """
        self.aqx_client.cancel_quantum_task(quantumTaskArn=arn)
    ...
    def create_quantum_task(self, **boto3_kwargs) -> str:
        ...
        Args:
            **boto3_kwargs: Keyword arguments for the Qx CreateQuantumTask API.

        Returns:
            str: Quantum task ARN.
        """
        response = self.aqx_client.create_quantum_task(**boto3_kwargs)
    ...
    def get_quantum_task(self, arn: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: Qx GetQuantumTask API result.
        """
        return self.aqx_client.get_quantum_task(quantumTaskArn=arn)
    ...
    def get_qpu_metadata(self, arn: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.aqx_client.describe_qpus(qpuArns=[arn])
    ...
    def get_simulator_metadata(self, arn: str) -> Dict[str, Any]:
        ...
        """
        try:
            response = self.aqx_client.describe_quantum_simulators(quantumSimulatorArns=[arn])
