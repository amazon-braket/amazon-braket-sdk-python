...
from aqx.qdk.circuits.ascii_circuit_diagram import AsciiCircuitDiagram
from aqx.qdk.circuits.instruction import Instruction
from aqx.qdk.circuits.moments import Moments
...
class Circuit:
    ...
    quantum device. See :mod:`aqx.qdk.circuits.gates` module for all the supported instructions.
    """
