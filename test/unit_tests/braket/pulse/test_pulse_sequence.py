...
def test_pulse_sequence_make_bound_pulse_sequence(predefined_frame_1, predefined_frame_2):
    ...
    expected_str_unbound = "\n".join(
        [
            "OPENQASM 3.0;",
            "cal {",
            "    waveform gauss_wf = gaussian(length_g, sigma_g, 1, false);",
            "    waveform drag_gauss_wf = drag_gaussian(length_dg, sigma_dg, 0.2, 1, false);",
            "    waveform constant_wf = constant(length_c, 2.0 + 0.3im);",
            ...
            "    delay[a + 2*b] predefined_frame_1, predefined_frame_2;",
            "    delay[a + 2*b] predefined_frame_1;",
    ...
    expected_str_b_bound = "\n".join(
        [
            "OPENQASM 3.0;",
            "cal {",
            "    waveform gauss_wf = gaussian(1.0ms, sigma_g, 1, false);",
            ...
            "    psb[0] = capture_v0(predefined_frame_1);",
            "    delay[a + 4] predefined_frame_1, predefined_frame_2;",
            "    delay[a + 4] predefined_frame_1;",
            "    delay[1.0ms] predefined_frame_1;",
            "    barrier predefined_frame_1, predefined_frame_2;",
            "    play(predefined_frame_1, gauss_wf);",
            "    play(predefined_frame_2, drag_gauss_wf);",
