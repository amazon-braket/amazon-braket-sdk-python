...
valid_supportedResultTypes = [{'maxShots': 20000, 'minShots': 1, 'name': 'Probability', 'observables': None}]
...
minimal_valid_device_properties_dict = {'action': {'braket.ir.openqasm.program': {'actionType': 'braket.ir.openqasm.program',
                                           ...
                                           'version': ['1.0']}},
 'paradigm': {'connectivity': {'connectivityGraph': valid_connectivityGraph,
                               'fullyConnected': False},
              'nativeGateSet': valid_nativeGateSet,
              'qubitCount': 2},
 'standardized': {'oneQubitProperties': {'1': valid_oneQubitProperties,
...
reduced_standardized_gate_model_qpu_device_properties_dict = {'action': {'braket.ir.openqasm.program': {'actionType': 'braket.ir.openqasm.program',
                                           'supportedOperations': [],
                                           'supportedResultTypes': valid_supportedResultTypes,
                                           'version': ['1']}},
 'braketSchemaHeader': {'name': 'braket.device_schema.iqm.iqm_device_capabilities',
                        'version': '1'},
 'deviceParameters': {},
 'paradigm': {'braketSchemaHeader': {'name': 'braket.device_schema.gate_model_qpu_paradigm_properties',
                                     'version': '1'},
              'connectivity': {'connectivityGraph': {'1': ['2']},
                               'fullyConnected': False},
              'nativeGateSet': ['cz', 'prx'],
              'qubitCount': 2},
 'service': {'braketSchemaHeader': {'name': 'braket.device_schema.device_service_properties',
                                    'version': '1'},
             'executionWindows': [],
             'shotsRange': [1, 20000],
             'updatedAt': '2024-04-04T01:10:02.869136'},
 'standardized': {'braketSchemaHeader': {'name': 'braket.device_schema.standardized_gate_model_qpu_device_properties',
                                         'version': '1'},
                  'oneQubitProperties': {'1': valid_oneQubitProperties,
                                         '2': valid_oneQubitProperties,},
                  'twoQubitProperties': {'1-2': valid_twoQubitProperties}}}