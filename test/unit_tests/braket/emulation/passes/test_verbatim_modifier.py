...
@pytest.fixture
def verbatim_modifier():
    return VerbatimModifier()


def test_removes_verbatim_boxes(verbatim_modifier):
...
def test_preserves_result_types(verbatim_modifier):
...
def test_circuit_without_verbatim_unchanged(verbatim_modifier):
...
def test_multiple_verbatim_boxes(verbatim_modifier):
