...
def test_adjoint_1q():
    ...
    _assert_correct_diagram(circ.adjoint(), expected)


def test_adjoint_1q_free_parameter():
    circ = Circuit().s(0).rz(0, FreeParameter("theta"))
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |      0      |  1  |",
        "                          ",
...
def test_adjoint_1q_result():
    circ = Circuit().s(0).rz(0, 3.14).expectation(Observable.X(), 0)
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |     0      |  1  | Result Types |",
        "                                        ",
        "q0 : -(Rz(3.14))^†-(S)^†-Expectation(X)-",
        "",
        "T  : |     0      |  1  | Result Types |",
    )
    _assert_correct_diagram(circ.adjoint(), expected)
...
def test_adjoint_1q_verbatim_result():
    circ = Circuit().s(0).add_verbatim_box(Circuit().rz(0, 3.14)).expectation(Observable.X(), 0)
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |      0      |     1      |     2     |  3  | Result Types |",
        "                                                                  ",
        "q0 : -StartVerbatim-(Rz(3.14))^†-EndVerbatim-(S)^†-Expectation(X)-",
        "",
        "T  : |      0      |     1      |     2     |  3  | Result Types |",
    )
    _assert_correct_diagram(circ.adjoint(), expected)
...
def test_adjoint_subcircuit():
    circ = Circuit().h(0).add_circuit(Circuit().s(0).rz(0, 3.14).adjoint()).x(0)
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |0|     1      |  2  |3|",
        "                             ",
...
def test_adjoint_2q():
    circ = Circuit().rx(0, 3.14).iswap(0, 1)
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |    0    |     1      |",
        "                             ",
...
def test_adjoint_2q_control():
    circ = Circuit().rx(0, 3.14).cphaseshift(0, 1, 3.14)
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |       0       |     1      |",
        "                                   ",
...
def test_adjoint_2q_xx():
    circ = Circuit().rx(0, 3.14).xx(0, 1, 3.14)
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |     0      |     1      |",
        "                                ",
...
def test_adjoint_3q():
    circ = Circuit().rx(0, 3.14).cswap(0, 1, 2)
    # Column formats to length of the gate plus the ascii representation for the angle.
    expected = (
        "T  : |   0    |     1      |",
        "                            ",
