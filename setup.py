...
setup(
    ...
    install_requires=[
        ...
        "amazon-braket-default-simulator @ git+https://github.com/aws/amazon-braket-default-simulator-python.git@7cbf7eed584968da759c871140ed43b598e0f34d#egg=amazon-braket-default-simulator",  # noqa E501
        "oqpy~=0.3.3",
        "setuptools",
        "backoff",
        "boltons",
