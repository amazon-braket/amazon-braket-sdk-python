...
setup(
    ...
    install_requires=[
        ...
        "amazon-braket-default-simulator @ git+https://github.com/amazon-braket/amazon-braket-default-simulator-python.git@fb1d2de5f35b784dd098734ce3bcb016b1308748#egg=amazon-braket-default-simulator",  # noqa E501
        "oqpy~=0.3.5",
        "backoff",
        "boltons",
        "boto3>=1.28.53",
