...
setup(
    ...
    install_requires=[
        ...
        "amazon-braket-default-simulator @ git+https://github.com/aws/amazon-braket-default-simulator-python.git@da5f1d4b6c3b7dfb279e053e114d699243319ae7#egg=amazon-braket-default-simulator",  # noqa E501
        "oqpy~=0.3.3",
        "setuptools",
        "backoff",
        "boltons",
